...
const faqs: Faq[] = [
  ...
  },
  {
    ...
    answer:
      "The widget renders inside a Shadow DOM, so its styles and your site's styles cannot reach each other. It is served gzipped at roughly 20 KB, loads asynchronously, and pulls in no third-party scripts or fonts — the only network requests it makes are to the Garuda API.",
  },
  {
